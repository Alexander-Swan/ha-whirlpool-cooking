...
| `fan` | Hood fan | Multi-speed hood exhaust fan when `Hood_OperationSetExhaustFanSpeed` is present. The raw Whirlpool speeds are mapped to Home Assistant fan percentage. |
...
fan supports six Whirlpool speed levels.
